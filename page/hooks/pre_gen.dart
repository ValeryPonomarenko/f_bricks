...
Future<void> run(HookContext context) async {
  ...
  final presenterName = "${stem}ViewModel";
  final presentationModelName = "${stem}PresentationViewState";
  final initialParamsName = "${stem}InitialParams";
  final viewModelName = "${stem}ViewState";
  ...
  final presenterFileName = "${stem.snakeCase}_view_model.dart";
  final presenterTestFileName = "${stem.snakeCase}_view_model_test.dart";
  final presentationModelFileName = "${stem.snakeCase}_presentation_view_state.dart";
